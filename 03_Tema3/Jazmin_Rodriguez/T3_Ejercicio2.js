...
function duplicador(array) {
    const arrayDuplicado = array.filter(numero => numero % 2 === 0).map(numero => numero * 2);
    return arrayDuplicado;
  }
  console.log("Resultado", duplicador([1, 2, 3, 4, 6, 10, 45, 68]));
...
function media(array) {
  ...
  console.log("Resultado",media([1, 2, 3, 4, 6, 10, 45, 68]));
...
function eliminarDuplicados(array) {
    const arrayUnico = array.filter((elemento) => array.indexOf(elemento) === array.lastIndexOf(elemento));
    return arrayUnico;
  }
  console.log("Resultado",eliminarDuplicados([5, 1, 2, 1, 3, 3, 4, 5]));
