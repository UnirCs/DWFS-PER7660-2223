...
function esPalindromo(cadena) {
    var cadena_inicial = cadena.split(" ").join("")
    var cadena_reversed = cadena_inicial.split("").reverse().join("")
    return cadena_inicial.toLowerCase() === cadena_reversed.toLowerCase() ? true : false
}
