...
function redConverter() {
    ...
    console.log(pixels[400][850]);
    console.log(pixels[400][850][0]);
    console.log(pixels[400][850][1]);
    console.log(pixels[400][850][2]);

    //Aqui tu codigo
    for (let i = 0; i < pixels.length; i++) {
        for (let j = 0; j < pixels[i].length; j++) {
            // Colocamos en cero los canales verde y azul
            pixels[i][j][1] = 0;
            pixels[i][j][2] = 0;
        }
    }
...
function greenConverter() {
    ...
    for (let i = 0; i < pixels.length; i++) {
        for (let j = 0; j < pixels[i].length; j++) {
            // Colocamos en cero los canales rojo y azul
            pixels[i][j][0] = 0;
            pixels[i][j][2] = 0;
        }
    }
...
function greyConverter() {
    ...
    for (let i = 0; i < pixels.length; i++) {
        for (let j = 0; j < pixels[i].length; j++) {
            ...
            let media = Math.trunc((pixels[i][j][0] + pixels[i][j][1] + pixels[i][j][2]) / 3);
...
function blackAndWhiteConverter() {
    ...
    for (let i = 0; i < pixels.length; i++) {
        for (let j = 0; j < pixels[i].length; j++) {
            ...
            pixels[i][j] = media < 128 ? [0,0,0] : [255,255,255];
...
function scaleDown() {
    ...
    handler.savePixels(imgScale, outputPath, handler.getShape()[0] / 2, handler.getShape()[1] / 2);
}
...
function dimBrightness(dimFactor) {
    ...
    for (let i = 0; i < pixels.length; i++) {
        for (let j = 0; j < pixels[i].length; j++) {
            ...
            pixels[i][j][0] = Math.trunc(pixels[i][j][0] / dimFactor);
            pixels[i][j][1] = Math.trunc(pixels[i][j][1] / dimFactor);
            pixels[i][j][2] = Math.trunc(pixels[i][j][2] / dimFactor);
