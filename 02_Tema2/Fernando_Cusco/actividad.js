...
function redConverter() {
    ...
    for (let index = 0; index < pixels.length; index++) {
        for (let col = 0; col < pixels[index].length; col++) {
            pixels[index][col] = [pixels[index][col][0], 0, 0];
        }
    }
...
function greenConverter() {
    ...
    for (let index = 0; index < pixels.length; index++) {
        for (let col = 0; col < pixels[index].length; col++) {
            pixels[index][col] = [0, pixels[index][col][0], 0];
        }
    }
    handler.savePixels(pixels, outputPath);
}
...
function blueConverter() {
    ...
    for (let index = 0; index < pixels.length; index++) {
        for (let col = 0; col < pixels[index].length; col++) {
            pixels[index][col] = [0, 0, pixels[index][col][0]];
        }
    }
...
function greyConverter() {
    ...
    for (let index = 0; index < pixels.length; index++) {
        for (let col = 0; col < pixels[index].length; col++) {
            const media = (pixels[index][col][0] + pixels[index][col][1] + pixels[index][col][2]) / 3;
            pixels[index][col] = [media, media, media];
        }
    }
    handler.savePixels(pixels, outputPath);
}
...
function blackAndWhiteConverter() {
    ...
    for (let index = 0; index < pixels.length; index++) {
        for (let col = 0; col < pixels[index].length; col++) {
            const media = (pixels[index][col][0] + pixels[index][col][1] + pixels[index][col][2]) / 3;
            pixels[index][col] = (media < 128) ? [0, 0, 0] : [255, 255, 255];
        }
    }
...
function scaleDown() {
    ...
    for (let index = 0; index < pixels.length; index +=2) {
        let fila = [];
        for (let j = 0; j < pixels[index].length; j +=2) {
            fila.push(pixels[index][j]);
        }
        nuevaImagen.push(fila)
    }
...
function dimBrightness(dimFactor) {
    ...
    for (let index = 0; index < pixels.length; index++) {
        for (let col = 0; col < pixels[index].length; col++) {
            pixels[index][col] = [pixels[index][col][0] / dimFactor, pixels[index][col][1] / dimFactor, pixels[index][col][2] / dimFactor];
        }
    }
    handler.savePixels(pixels, outputPath);
}
...
function invertColors() {
    ...
    for (let index = 0; index < pixels.length; index++) {
        for (let col = 0; col < pixels[index].length; col++) {
            pixels[index][col] = [255 - pixels[index][col][0], 255 - pixels[index][col][1], 255 - pixels[index][col][2]];
        }
    }
    handler.savePixels(pixels, outputPath);
}
