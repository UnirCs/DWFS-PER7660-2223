...
function redConverter() {
    ...
    /*Obtenemos los arreglos que se encuentran dentro de pixels y manipulamos las posiciones 1 y 2 de cada uno de los
        elementos siendo 1 el representante de g y 2 el representante de b*/
...
function scaleDown() {
    ...
    let pixels = handler.getPixels();
    let nuevaImagen = pixels.filter((element, elementI) => elementI % 2 === 0)
        .map((element) => element.filter((property, propertyI) => propertyI % 2 === 0));
