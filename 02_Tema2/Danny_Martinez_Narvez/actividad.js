...
function scaleDown() {
    ...
    for (let i = 0; i < pixels.length; i+=2) {
        ...
        for (let j = 0; j < pixels[i].length; j+=2) {
            linea.push(pixels[i][j]);
        }
        pixelNuevo.push(linea);
    }
    handler.savePixels(pixelNuevo, outputPath, handler.getShape()[0] / 2, handler.getShape()[1] / 2);
}
 ...
 * En la carpeta ../00_RESOURCES/output/ apareceran los resultados para cada uno de los casos
 *
 *     Ejecutar ejemplo: 0
 *     Conversor a rojos: 1
