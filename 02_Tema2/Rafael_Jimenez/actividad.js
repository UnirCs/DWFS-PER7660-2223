...
function redConverter() {
    ...
    for(let index = 0; index < pixels.length; index++) {
        for(let index2 = 1; index2 < pixels[index].length; index2++){
            pixel = pixels[index][index2]
            pixel[1] = 0
            pixel[2] = 0
        }
    }
...
function greyConverter() {
    ...
    for(let index = 0; index < pixels.length; index++) {
        for(let index2 = 1; index2 < pixels[index].length; index2++){
            pixel = pixels[index][index2]
            pixel_gray = (pixel[0] + pixel[1] +pixel[2]) / 3
            pixel[0] = pixel_gray
            pixel[1] = pixel_gray
            pixel[2] = pixel_gray
        }
...
function scaleDown() {
    ...
    for(let index = 0; index < pixels.length; index+=2) {
        let pares = []
        for(let index2 = 1; index2 < pixels[index].length; index2+=2){
            pares.push(pixels[index][index2])

        }
        nuevaImagen.push(pares)
