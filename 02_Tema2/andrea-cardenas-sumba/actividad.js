...
function redConverter() {
  ...
  for (let i = 0; i < pixels.length; i++) {
    for (let j = 0; j < pixels[i].length; j++) {
      const [red] = pixels[i][j];
      const nuevoPixel = [red, 0, 0];
...
function greenConverter() {
  ...
  for (let i = 0; i < pixels.length; i++) {
    for (let j = 0; j < pixels[i].length; j++) {
      const [, green] = pixels[i][j];
      const nuevoPixel = [0, green, 0];
      pixels[i][j] = nuevoPixel;
    }
  }
  handler.savePixels(pixels, outputPath);
...
function blueConverter() {
  ...
  for (let i = 0; i < pixels.length; i++) {
    for (let j = 0; j < pixels[i].length; j++) {
      const [, , blue] = pixels[i][j];
      const nuevoPixel = [0, 0, blue];
      pixels[i][j] = nuevoPixel;
    }
  }
  handler.savePixels(pixels, outputPath);
...
function greyConverter() {
  ...
  for (let i = 0; i < pixels.length; i++) {
    for (let j = 0; j < pixels[i].length; j++) {
      const [red, green, blue] = pixels[i][j];
      const media = (red + green + blue) / pixels[i][j].length;
      //const mediaInt = parseInt(media);
      //const nuevoPixel = [mediaInt, mediaInt, mediaInt];
      const nuevoPixel = [media, media, media];
      pixels[i][j] = nuevoPixel;
    }
  }
  handler.savePixels(pixels, outputPath);
...
function dimBrightness(dimFactor) {
  ...
  for (let i = 0; i < pixels.length; i++) {
    for (let j = 0; j < pixels[i].length; j++) {
      const [red, green, blue] = pixels[i][j];
      const nuevoPixel = [red / dimFactor, green / dimFactor, blue / dimFactor];
      pixels[i][j] = nuevoPixel;
    }
  }
  handler.savePixels(pixels, outputPath);
...
function invertColors() {
  ...
  for (let i = 0; i < pixels.length; i++) {
    for (let j = 0; j < pixels[i].length; j++) {
      const [red, green, blue] = pixels[i][j];
      const nuevoPixel = [255 - red, 255 - green, 255 - blue];
      pixels[i][j] = nuevoPixel;
    }
  }
  handler.savePixels(pixels, outputPath);
