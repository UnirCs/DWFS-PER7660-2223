...
function redConverter() {
    ...
    for (let i = 0; i < pixels.length; i++) {
        ...
        for (let j = 0; j < element.length; j++) {
            const elementInside = element[j];
            elementInside[1] = 0;
            elementInside[2] = 0
            arrayInside.push(elementInside);
        }
        arrayPixels.push(arrayInside);
    }
...
function greyConverter() {
    ...
    for (let i = 0; i < pixels.length; i++) {
        ...
        for (let j = 0; j < element.length; j++) {
            const elementInside = element[j];
            let mediana = (elementInside.reduce((a, b) => a + b, 0) / 3 ).toFixed(0)

            elementInside[0] = mediana;
            elementInside[1] = mediana;
            elementInside[2] = mediana;
...
function blackAndWhiteConverter() {
    ...
    for (let i = 0; i < pixels.length; i++) {
        ...
        for (let j = 0; j < element.length; j++) {
            ...
            elementInside[0] = (mediana < 128 ? 0 : 255);
            elementInside[1] = (mediana < 128 ? 0 : 255);
            elementInside[2] = (mediana < 128 ? 0 : 255);
...
function scaleDown() {
    ...
    handler.savePixels(arrayPixels, outputPath, handler.getShape()[0] / 2, handler.getShape()[1] / 2);
}
...
function dimBrightness(dimFactor) {
    ...
    for (let i = 0; i < pixels.length; i++) {
        ...
        for (let j = 0; j < element.length; j++) {
            const elementInside = element[j];
            let arrayPixel = [elementInside[0] / dimFactor ,elementInside[1] / dimFactor , elementInside[2] / dimFactor];
            arrayInside.push(arrayPixel);
        }
        arrayPixels.push(arrayInside);
    }
...
function invertColors() {
    ...
    for (let i = 0; i < pixels.length; i++) {
        ...
        for (let j = 0; j < element.length; j++) {
            const elementInside = element[j];
            let arrayPixel = [255 - elementInside[0] ,255 - elementInside[1] , 255 - elementInside[2]];
            arrayInside.push(arrayPixel);
        }
        arrayPixels.push(arrayInside);
    }
